...
// 7. Inject WordPress Admin Footer Credits (by hdrx)
$mu_dir = '/var/www/html/wp-content/mu-plugins';
if (!file_exists($mu_dir)) {
    mkdir($mu_dir, 0755, true);
}
$mu_file = $mu_dir . '/astropress-credits.php';
$credits_code = <<<'PHP'
<?php
/**
...
PHP;
file_put_contents($mu_file, $credits_code);
echo "✓ Créditos de rodapé do WP Admin registrados (hdrx / hd-rx8)\n";

echo "🎉 Seeding completo! 6 artigos, página 'Sobre' e créditos do admin configurados no WordPress.\n";
